...
INSERT INTO EMPLOYEES(EMPLOYEE_ID, `NAME`, EMAIL, `ROLE`, PASSWORD_HASH, SUPERVISOR_ID)
...
INSERT INTO NOTES(ID, ONE_TO_ONE_ID, NOTE) VALUES (1, 1, 'good well-being');
INSERT INTO NOTES(ID, ONE_TO_ONE_ID, NOTE) VALUES (2, 2, 'great well-being');
INSERT INTO NOTES(ID, ONE_TO_ONE_ID, NOTE) VALUES (3, 3, 'no issues');
INSERT INTO NOTES(ID, ONE_TO_ONE_ID, NOTE) VALUES (4, 4, 'anything');