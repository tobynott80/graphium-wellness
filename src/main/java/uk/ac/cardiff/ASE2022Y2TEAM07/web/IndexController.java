...
public class IndexController {
    ...
    public IndexController(EmployeeRepository employeeRepository, CheckinService checkinService) {
    ...
    public ModelAndView getEmployeeHomepage(Model model) {
        ...
        Integer averageCheckin =  checkinService.getAvgByEmployeeId(this.getCurrentEmployee().getEmployeeId());
        model.addAttribute("averageCheckin", averageCheckin);
